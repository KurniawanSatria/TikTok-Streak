...
const main = async () => {
  ...
  try {
    ...
    if (isDebug) console.log(yellow('  [~] Mengambil dan menyimpan update cookies...'))
    const currentCookies = await page.cookies()
    fs.writeFileSync(CREDENTIALS_FILE, JSON.stringify(currentCookies, null, 2))
    if (isDebug) console.log(green('  [✓] Cookies berhasil diupdate!'))
